<?php $__env->startSection('title', 'Generate Bracket'); ?>
...
<div class="container-fluid py-4">
    ...
    <form id="bracketConfigForm" action="<?php echo e(route('admin.tournament.bracket.arrange')); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="sport-grid">
                    <?php $__currentLoopData = $sports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="sport-card">
                            <input type="radio" name="sport_id" value="<?php echo e($sport->id); ?>" required>
                            <div class="sport-card-inner">
                                <i class="bi <?php echo e($sport->icon ?? 'bi-trophy'); ?> sport-icon"></i>
                                <span class="sport-name"><?php echo e($sport->nama_sport); ?></span>
            ...
            <div class="bb-section-body">
                <div class="size-grid">
                    ...
                    <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="size-card">
                            <input type="radio" name="bracket_size" value="<?php echo e($sz['v']); ?>" <?php echo e($sz['v'] === 8 ? 'checked' : ''); ?> required>
                            <div class="size-card-inner">
                                <div class="size-num"><?php echo e($sz['v']); ?></div>
                                <div class="size-label"><?php echo e($sz['label']); ?></div>
                                <div class="size-desc"><?php echo e($sz['desc']); ?></div>
                                <div class="size-rounds">
                                    <?php for($i = 0; $i < $sz['rounds']; $i++): ?>
        ...
        <div class="bb-section mb-4">
            ...
            <div class="bb-section-body">
                <div class="prodi-grid">
                    <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodi => $prodiTeams): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="prodi-card-bb">
                            <div class="prodi-head">
                                <span class="prodi-name"><i class="bi bi-mortarboard mr-1"></i><?php echo e($prodi); ?></span>
                                <span class="prodi-count"><?php echo e(count($prodiTeams)); ?></span>
                            </div>
                            <div class="prodi-body">
                                <?php $__currentLoopData = $prodiTeams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" class="team-pick"
                                        ...
                                        <span class="team-pick-avatar"><?php echo e(strtoupper(substr($team->name, 0, 1))); ?></span>
                                        <span class="team-pick-name"><?php echo e($team->name); ?></span>
        ...
        <div class="bb-footer">
            <a href="<?php echo e(route('admin.index')); ?>" class="btn btn-outline-light">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\!UKDW\tugas-akhir\sistem-rectorcup\resources\views/admin/bracket-builder.blade.php ENDPATH**/ ?>