<?php $__env->startSection('title', 'Kelola Skor'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(session('error')): ?>
        <div class="alert alert-danger border-0 shadow-sm mb-4 py-3" style="border-radius: 16px; background: rgba(239, 68, 68, 0.1); color: #f87171;">
            <h6 class="font-weight-bold mb-0"><i class="bi bi-exclamation-triangle-fill mr-2"></i> <?php echo e(session('error')); ?></h6>
        </div>
    <?php endif; ?>

    <div class="row">
        <?php $liveMatches = $pertandingans->where('status', 'live'); ?>
        ...
        <?php else: ?>
            <?php $__currentLoopData = $liveMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-6 mb-4" data-match-id="<?php echo e($p->id); ?>">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <span class="badge-primary">
                                    ...
                                    <?php echo e($p->sport->nama_sport ?? 'Tournament'); ?>

                                </span>
                                <span class="text-muted small"><i class="bi bi-geo-alt mr-1"></i> <?php echo e($p->lokasi); ?></span>
                            </div>

                            <form action="<?php echo e(url('/pertandingan/' . $p->id . '/update-score')); ?>" method="POST"
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>

                                <?php if(!$p->team_a_id || !$p->team_b_id): ?>
                                    ...
                                    <div class="text-center py-5 px-3">
                                        ...
                                        <p class="text-muted small mb-0" style="max-width: 300px; margin: 0 auto;">
                                            <?php echo e(!$p->team_a_id ? 'Tim A' : ''); ?><?php echo e(!$p->team_a_id && !$p->team_b_id ? ' & ' : ''); ?><?php echo e(!$p->team_b_id ? 'Tim B' : ''); ?> 
                                ...
                                <div class="bg-dark-subtle rounded-xl p-4 mb-4"
                                    ...
                                    <?php else: ?>
                                        <div class="row align-items-center text-center">
                                            <div class="col-5">
                                                <label
                                                    class="small font-weight-bold text-muted text-uppercase mb-3 d-block text-truncate"><?php echo e($p->teamA?->name ?? 'TBD'); ?></label>
                                            ...
                                            <div class="col-5">
                                                <label
                                                    class="small font-weight-bold text-muted text-uppercase mb-3 d-block text-truncate"><?php echo e($p->teamB?->name ?? 'TBD'); ?></label>
                                                <div class="d-flex flex-column align-items-center">
                                                    <button type="button"
                                                        class="btn btn-outline-primary btn-sm rounded-pill mb-2 w-100 score-btn score-btn-up"
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-outline-primary btn-sm rounded-pill mt-2 w-100 score-btn score-btn-down"
                                                        data-for="score_b_<?php echo e($p->id); ?>"
                                                        onclick="decrementScore('score_b_<?php echo e($p->id); ?>')"
                                                        <?php if($p->score_b <= 0): ?> disabled <?php endif; ?>>
                                                        <i class="bi bi-chevron-down"></i>
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <?php if(($p->format_tanding ?? '') === 'BO3'): ?>
                                    <div class="mb-4 p-3 rounded-lg"
                                        ...
                                        <?php for($i = 1; $i <= 3; $i++): ?>
                                            <?php $game = $p->games->where('game_number', $i)->first(); ?>
                                            <div class="row align-items-center mb-3">
                                                <div class="col-md-3">
                                                    <span class="small font-weight-bold text-muted">Game <?php echo e($i); ?></span>
                                                </div>
                                                <div class="col-md-9">
                                                    <div class="custom-file custom-file-sm">
                                                        <input type="file" name="game_screenshots[<?php echo e($i); ?>]" class="custom-file-input"
                                                            id="game_ss<?php echo e($p->id); ?>_<?php echo e($i); ?>">
                                                        <label class="custom-file-label small" for="game_ss<?php echo e($p->id); ?>_<?php echo e($i); ?>"
                                                            ...
                                                            <?php echo e($game && $game->screenshot ? 'Update SS' : 'Upload SS Game ' . $i); ?>
                                    ...
                                    <div class="mb-4 p-3 rounded-lg"
                                        ...
                                        <div class="custom-file custom-file-sm">
                                            <input type="file" name="screenshot" class="custom-file-input"
                                                id="screenshot<?php echo e($p->id); ?>">
                                            <label class="custom-file-label small" for="screenshot<?php echo e($p->id); ?>"
                                                style="background: rgba(15, 23, 42, 0.5); border: 1px solid var(--glass-border); color: var(--text-muted); border-radius: 8px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                                <?php echo e($p->screenshot ? 'Update Screenshot Bukti' : 'Upload Screenshot Bukti'); ?>
                                ...
                                <input type="hidden" name="status" id="statusField_<?php echo e($p->id); ?>" value="live">
                                ...
                                <?php if(session('success') && session('updated_id') == $p->id): ?>
                        ...
                        <div class="card-header bg-transparent border-0 pt-4 px-4 pb-0">
                            <div class="d-flex align-items-center">
                                <div class="bg-primary rounded-circle p-2 d-flex align-items-center justify-content-center mr-3"
                                    ...
                                    <i class="bi <?php echo e($tournament->sport->icon ?? 'bi-diagram-3'); ?> text-white small"></i>
                                </div>
                                <h6 class="text-white font-weight-bold mb-0"><?php echo e($tournament->name); ?> <span class="text-muted small ml-2"><?php echo e($tournament->sport->nama_sport); ?></span></h6>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $tMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr data-match-id="<?php echo e($p->id); ?>">
                                                <td class="small text-muted align-middle"><?php echo e($p->babak); ?></td>
                                                <td class="align-middle">
                                                    <div class="text-white small font-weight-bold"><?php echo e($p->waktu_tanding->format('H:i')); ?></div>
                                                    <div class="text-muted small"><?php echo e($p->waktu_tanding->format('d M')); ?></div>
                                                </td>
                                                <td class="align-middle">
        ...
        <?php $__currentLoopData = $pertandingans->where('status', 'scheduled'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal fade" id="quickLive<?php echo e($p->id); ?>" tabindex="-1" role="dialog">
                        ...
                        <form action="<?php echo e(url('/pertandingan/' . $p->id . '/update-score')); ?>" method="POST">
                            ...
                            <div class="modal-body text-center p-5">
                                ...
                                <h4 class="text-white font-weight-bold mb-4">
                                    <?php echo e($p->teamA?->name ?? 'TBD'); ?> VS <?php echo e($p->teamB?->name ?? 'TBD'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\!UKDW\tugas-akhir\sistem-rectorcup\resources\views/admin/skor.blade.php ENDPATH**/ ?>