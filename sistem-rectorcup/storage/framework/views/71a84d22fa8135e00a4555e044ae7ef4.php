<?php $__env->startSection('title', 'Atur Bracket — ' . $tournamentName); ?>
    ...
    <div class="mb-4 d-flex align-items-center justify-content-between">
        <div>
            ...
            <p class="text-muted mb-0">
                <?php echo e($tournamentName); ?> &mdash; <?php echo e($sport->nama_sport); ?> &mdash; <?php echo e($bracketSize); ?> Tim
            </p>
        ...
        <a href="<?php echo e(route('admin.tournament.bracket.builder')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 p-3" style="background: rgba(99,102,241,0.08); border: 1px solid rgba(99,102,241,0.2); border-radius: 10px;">
        ...
        <div>
            <span class="badge badge-pill px-3 py-2" id="placedCounter" style="background:#1e2540; color:#a5b4fc; font-size:0.85rem;">
                <i class="bi bi-check2-circle mr-1"></i><span id="placedCount">0</span>/<?php echo e($bracketSize); ?> ditempatkan
            </span>
        </div>
    </div>
        ...
        <div class="team-panel-sticky">
            <div class="card border-0" style="background: rgba(255,255,255,0.04); border-radius: 12px;">
                <div class="card-header bg-transparent border-0 pb-2 pt-3 px-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge badge-primary" id="poolCount"><?php echo e(count($selectedTeams)); ?></span>
                </div>
                <div class="card-body p-2" id="availableTeams">
                    <?php $__currentLoopData = $selectedTeams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="team-card"
                             draggable="true"
                            ...
                            <div class="team-card-inner">
                                ...
                                <div class="team-avatar"><?php echo e(strtoupper(substr($team->name, 0, 1))); ?></div>
                                <span class="team-name"><?php echo e($team->name); ?></span>
...
<form id="saveBracketForm" action="<?php echo e(route('admin.tournament.bracket.store')); ?>" method="POST" class="d-none">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="tournament_name" value="<?php echo e($tournamentName); ?>">
    <input type="hidden" name="sport_id"        value="<?php echo e($sportId); ?>">
    <input type="hidden" name="bracket_size"    value="<?php echo e($bracketSize); ?>">
...
<script>
const teamsData  = <?php echo json_encode($selectedTeams->map(fn($t) => ['id' => $t->id, 'name' => $t->name]), 512) ?>;
const bracketSize = <?php echo e($bracketSize); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\!UKDW\tugas-akhir\sistem-rectorcup\resources\views/admin/bracket-arrange.blade.php ENDPATH**/ ?>