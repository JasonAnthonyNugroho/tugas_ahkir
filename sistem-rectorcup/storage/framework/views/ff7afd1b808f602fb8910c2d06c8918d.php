...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-5">
        <div class="card filter-card p-4">
            <form action="<?php echo e(route('history')); ?>" method="GET" class="row align-items-center">
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="input-group modern-filter-group">
                        ...
                        <select name="sport_id" class="form-control" style="background: transparent;">
                            <option value="all" <?php echo e($selectedSportId == 'all' ? 'selected' : ''); ?>>
                                Semua Cabang Olahraga
                            </option>
                            <?php $__currentLoopData = $sports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sport->id); ?>" <?php echo e($selectedSportId == $sport->id ? 'selected' : ''); ?>>
                                    <?php echo e($sport->nama_sport); ?><?php echo e($sport->sub_kategori ? ' - ' . $sport->sub_kategori : ''); ?>
                ...
                <div class="col-md-4 d-flex align-items-center">
                    ...
                    <a href="<?php echo e(route('history')); ?>" class="btn btn-outline-secondary w-100 rounded-pill d-flex align-items-center justify-content-center" style="height: 42px;">
                        Reset
                    </a>
                </div>
            </form>
    ...
    <?php if($selectedTournament): ?>
        ...
        <div class="mb-5">
            <div class="mb-4">
                <a href="<?php echo e(route('history', ['year' => $selectedYear])); ?>" class="btn text-muted p-0 d-flex align-items-center hover-white">
            ...
            <div class="card p-4 mb-5" style="background: rgba(30, 41, 59, 0.4); border-radius: 24px; border: 1px solid var(--glass-border);">
                <div class="d-flex align-items-center mb-5">
                    <div class="bg-primary rounded-circle p-2 d-flex align-items-center justify-content-center mr-3"
                        ...
                        <i class="bi <?php echo e($selectedTournament->sport->icon ?? 'bi-diagram-3'); ?> text-white h4 mb-0"></i>
                    </div>
                    <div>
                        <h2 class="font-weight-bold mb-0 text-white"><?php echo e($selectedTournament->name); ?></h2>
                        <p class="text-muted mb-0 small text-uppercase tracking-wider"><?php echo e($selectedTournament->sport->nama_sport); ?> &bull; <?php echo e($selectedTournament->year); ?></p>
                    </div>
                </div>
                ...
                <?php if(!empty($selectedTournament->external_score_url)): ?>
                    <div class="row justify-content-center mb-5">
                        <div class="col-12 col-md-8 col-lg-6">
                            ...
                            <a href="<?php echo e($selectedTournament->external_score_url); ?>" target="_blank" rel="noopener noreferrer"
                ...
                <?php elseif($juara1 || $juara2 || $juara3): ?>
                    <div class="row justify-content-center mb-5">
                            ...
                            <div class="podium-row">
                                ...
                                <?php if($juara1): ?>
                                    <div class="podium-item podium-1">
                                        ...
                                        <div class="podium-team-name"><?php echo e($juara1->name); ?></div>
                                ...
                                <?php if($juara2): ?>
                                    <div class="podium-item podium-2">
                                        ...
                                        <div class="podium-team-name"><?php echo e($juara2->name); ?></div>
                                ...
                                <?php if($juara3): ?>
                                    <div class="podium-item podium-3">
                                        ...
                                        <div class="podium-team-name"><?php echo e($juara3->name); ?></div>
    ...
    <?php else: ?>
                ...
                <div class="row">
                    <?php $__currentLoopData = $tournaments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 col-lg-4 mb-4">
                            <a href="<?php echo e(route('history', ['tournament_id' => $tournament->id, 'year' => $selectedYear])); ?>" class="text-decoration-none">
                                <div class="card h-100 tournament-card border-0" 
                                    ...
                                    <div class="card-body p-4 text-center">
                                        <div class="sport-icon-container mb-3 mx-auto d-flex align-items-center justify-content-center"
                                            ...
                                            <i class="bi <?php echo e($tournament->sport->icon ?? 'bi-controller'); ?> text-white h2 mb-0"></i>
                                        </div>
                                        
                                        <h5 class="font-weight-bold text-white mb-1"><?php echo e(strtoupper($tournament->sport->nama_sport)); ?><?php echo e($tournament->sport->sub_kategori ? ' - ' . strtoupper($tournament->sport->sub_kategori) : ''); ?></h5>
                                        <p class="text-muted small text-uppercase tracking-widest mb-3"><?php echo e($tournament->name); ?></p>
        ...
        <?php if($history->isNotEmpty()): ?>
            ...
            <?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahun => $daftarPertandingan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="year-section mb-5">
                    <div class="d-flex align-items-center mb-4">
                        <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mr-3"
                            ...
                            <span class="text-white font-weight-bold"><?php echo e(substr($tahun, 2)); ?></span>
                        </div>
                        <h3 class="font-weight-bold mb-0 text-white">
                            Edisi Rector Cup <?php echo e($tahun); ?>
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $daftarPertandingan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                    ...
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-start mb-4">
                                            <span class="badge badge-primary px-3 py-1" style="border-radius: 100px;">
                                                <i class="bi <?php echo e($p->sport->icon ?? 'bi-trophy'); ?> mr-2"></i>
                                                <?php echo e($p->sport->nama_sport ?? 'Tournament'); ?><?php echo e($p->sport?->sub_kategori ? ' - ' . $p->sport->sub_kategori : ''); ?>
                                        ...
                                        <div class="row text-center align-items-center py-3">
                                            <div class="col-5">
                                                <h4 class="h6 font-weight-bold text-truncate mb-3 text-white"><?php echo e($cardLeft); ?></h4>
                                                <div class="h3 font-weight-bold text-white"><?php echo e($p->score_a); ?></div>
                                            </div>
                                            <div class="col-2 p-0">
                                                <div class="text-muted font-weight-bold small">VS</div>
                                            </div>
                                            <div class="col-5">
                                                <h4 class="h6 font-weight-bold text-truncate mb-3 text-white"><?php echo e($cardRight); ?></h4>
                                                <div class="h3 font-weight-bold text-white"><?php echo e($p->score_b); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-4 pt-4 border-top border-secondary d-flex justify-content-between align-items-center" style="border-color: rgba(255,255,255,0.05) !important;">
                                            <div class="small text-muted">
                                                <div class="d-flex align-items-center mb-1">
                                                    <i class="bi bi-calendar3 mr-2"></i> <?php echo e(\Carbon\Carbon::parse($p->waktu_tanding)->format('d M Y')); ?>

                                                </div>
                                            </div>
                                            <a href="<?php echo e(route('pertandingan.show', $p->id)); ?>" class="btn btn-outline-light btn-sm rounded-pill px-3">
                                                Detail
                                            </a>
                                        </div>
                                    </div>
        ...
        <?php if($history->isEmpty() && $tournaments->isEmpty()): ?>
...
<script>
    $(document).ready(function() {
        <?php if($selectedTournament && count($selectedTournament->pertandingans) > 0): ?>
        var bracketData = <?php echo json_encode($bracketData ?? ['teams' => [], 'results' => []]); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\!UKDW\tugas-akhir\sistem-rectorcup\resources\views/history.blade.php ENDPATH**/ ?>