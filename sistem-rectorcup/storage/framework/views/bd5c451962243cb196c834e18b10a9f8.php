<?php $__env->startSection('title', 'Detail Pertandingan'); ?>
                ...
                <div class="detail-header">
                    <div class="d-flex align-items-center">
                        <div class="sport-avatar mr-3">
                            <i class="bi <?php echo e($pertandingan->sport->icon ?? 'bi-trophy'); ?>"></i>
                        </div>
                        <div>
                            <h5 class="mb-0 font-weight-bold text-white">
                                <?php echo e($pertandingan->sport->nama_sport ?? 'Tournament'); ?>
                    ...
                    <div>
                        <?php if($pertandingan->status == 'live'): ?>
                            <span class="status-pill status-live">
                                <span class="live-dot"></span> LIVE
                            </span>
                        <?php elseif($pertandingan->status == 'finished'): ?>
                ...
                <div class="detail-body">
                    ...
                    <div class="score-board">
                        <div class="team-block">
                            <div class="team-emblem team-emblem-a">
                                <?php echo e(strtoupper(substr($pertandingan->teamA?->name ?? 'T', 0, 1))); ?>

                            </div>
                            <h3 class="team-name"><?php echo e($pertandingan->teamA?->name ?? 'TBD'); ?></h3>
                            <div class="team-prodi-badge"><?php echo e($pertandingan->teamA ? strtoupper($pertandingan->teamA->prodi) : '-'); ?></div>
                        </div>

                        <div class="score-display">
                            <div class="score-numbers">
                                <span><?php echo e($pertandingan->score_a); ?></span>
                                <span class="score-sep">:</span>
                                <span><?php echo e($pertandingan->score_b); ?></span>
                            </div>
                        ...
                        <div class="team-block">
                            <div class="team-emblem team-emblem-b">
                                <?php echo e(strtoupper(substr($pertandingan->teamB?->name ?? 'T', 0, 1))); ?>

                            </div>
                            <h3 class="team-name"><?php echo e($pertandingan->teamB?->name ?? 'TBD'); ?></h3>
                            <div class="team-prodi-badge"><?php echo e($pertandingan->teamB ? strtoupper($pertandingan->teamB->prodi) : '-'); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="match-info-grid">
                        <div class="info-cell">
                            ...
                            <p class="info-value"><i class="bi bi-geo-alt"></i><?php echo e($pertandingan->lokasi ?? '-'); ?></p>
                        </div>
                        <div class="info-cell">
                            <p class="info-label">Tanggal</p>
                            <p class="info-value"><i class="bi bi-calendar3"></i><?php echo e($pertandingan->waktu_tanding->format('d M Y')); ?></p>
                        </div>
                        <div class="info-cell">
                            <p class="info-label">Waktu</p>
                            <p class="info-value"><i class="bi bi-clock"></i><?php echo e($pertandingan->waktu_tanding->format('H:i')); ?> WIB</p>
                        </div>
                        <div class="info-cell">
                    ...
                    <?php if($pertandingan->games->isNotEmpty()): ?>
                        <div class="games-breakdown mb-5">
                            <h5 class="font-weight-bold text-white mb-4 d-flex align-items-center">
                                <i class="bi bi-controller mr-3 text-primary"></i> Detail Match (Best of <?php echo e($pertandingan->games->count()); ?>)
                            </h5>
                            <div class="row">
                                <?php $__currentLoopData = $pertandingan->games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="card h-100 border-0" style="background: rgba(255,255,255,0.03); border-radius: 20px; border: 1px solid var(--glass-border) !important;">
                                            <div class="card-header border-0 bg-transparent pt-4 px-4 pb-0">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <span class="badge badge-primary px-3 py-1" style="border-radius: 100px; font-size: 0.7rem;">MATCH <?php echo e($game->game_number); ?></span>
                                                    <?php if($game->winner_id): ?>
                                                        <span class="text-success small font-weight-bold">
                                                            <i class="bi bi-trophy-fill mr-1"></i> <?php echo e($game->winner?->name ?? 'Unknown'); ?>
                                            ...
                                            <div class="card-body p-4">
                                                <div class="text-center mb-3">
                                                    <div class="h4 font-weight-bold text-white mb-0">
                                                        <?php echo e($game->score_a); ?> <span class="text-muted mx-1">-</span> <?php echo e($game->score_b); ?>

                                                    </div>
                                                </div>
                                                
                                                <?php if($game->screenshot): ?>
                                                    <div class="game-screenshot-container" style="cursor: pointer;" onclick="window.open('<?php echo e(asset('storage/' . $game->screenshot)); ?>', '_blank')">
                                                        <img src="<?php echo e(asset('storage/' . $game->screenshot)); ?>" alt="Game <?php echo e($game->game_number); ?> SS" 
                    ...
                    <div class="evidence-section">
                        ...
                        <?php if($pertandingan->screenshot): ?>
                            <div class="card bg-black-20 border-0 p-2 overflow-hidden"
                                style="background: rgba(0,0,0,0.2); border-radius: 20px;">
                                <img src="<?php echo e(asset('storage/' . $pertandingan->screenshot)); ?>" alt="Screenshot Hasil"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\!UKDW\tugas-akhir\sistem-rectorcup\resources\views/detail.blade.php ENDPATH**/ ?>