...
<head>
    ...
    <script>
        ...
        try {
            ...
            const reverbHost = "<?php echo e(config('broadcasting.connections.reverb.options.host')); ?>";
            const reverbPort = "<?php echo e(config('broadcasting.connections.reverb.options.port', 8080)); ?>";
            const reverbScheme = "<?php echo e(config('broadcasting.connections.reverb.options.scheme', 'http')); ?>";
    ...
    <title>Rector Cup - <?php echo $__env->yieldContent('title'); ?></title>
    <style>
        :root {
            --bg-dark: #0f172a;
            --card-bg: #1e293b;
...
<body>
                ...
                <div class="col-auto">
                    <div class="dropdown">
                        <button
                            ...
                            <span class="d-none d-sm-inline mr-2 small"><?php echo e(Auth::user()->name ?? "Guest"); ?></span>
                            ...
                            style="background: var(--card-bg); border-radius: 16px; min-width: 200px;">
                                <?php if(auth()->guard()->check()): ?>
                                    <div class="px-4 py-3 border-bottom border-secondary mb-2">
                                        ...
                                        <p class="font-weight-bold mb-0 text-white"><?php echo e(Auth::user()->name); ?></p>
                                    </div>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-2 sidebar shadow-lg" id="sidebarMenu">
                <div class="nav flex-column nav-pills">
                    ...
                    <a class="nav-link <?php echo e(request()->is('history') ? 'active' : ''); ?>" href="<?php echo e(route('history')); ?>">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="mt-4">
                            ...
                            <a class="nav-link <?php echo e(request()->is('admin/skor') ? 'active' : ''); ?>"
                                href="<?php echo e(route('admin.skor')); ?>">
            ...
            <!-- Content Area -->
            <div class="<?php echo e(request()->routeIs('login') ? 'col-12' : 'col-lg-10'); ?> p-4 min-vh-100">
    ...
    <?php if(session('success') && !session('updated_id')): ?>
        <script>
            Swal.fire({
                title: 'Berhasil!',
...
</html><?php /**PATH D:\!UKDW\tugas-akhir\sistem-rectorcup\resources\views/layouts/app.blade.php ENDPATH**/ ?>