...
<?php $__env->startSection('title', 'Dashboard Live'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="mb-5">
            ...
            <div class="row" id="liveMatchContainer">
                <?php $__currentLoopData = $liveMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6 col-xl-4 mb-4 match-card" data-id="<?php echo e($p->id); ?>">
                        <div class="card h-100 shadow-sm border-0" style="border-radius: 24px; background: rgba(255,255,255,0.03); border: 1px solid var(--glass-border) !important; transition: all 0.3s ease;">
                            <div class="card-body p-4">
                                ...
                                <div class="row text-center align-items-center py-3">
                                    <div class="col-5">
                                        <h4 class="h6 font-weight-bold text-truncate mb-3 text-white"><?php echo e($p->teamA?->name ?? 'TBD'); ?></h4>
                                        <div class="display-4 font-weight-bold text-white score-a"><?php echo e($p->score_a); ?></div>
                                    </div>
                                    <div class="col-2 p-0">
                                        <div class="text-muted font-weight-bold small">VS</div>
                                    </div>
                                    <div class="col-5">
                                        <h4 class="h6 font-weight-bold text-truncate mb-3 text-white"><?php echo e($p->teamB?->name ?? 'TBD'); ?></h4>
                                        <div class="display-4 font-weight-bold text-white score-b"><?php echo e($p->score_b); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 pt-4 border-top border-secondary d-flex justify-content-between align-items-center" style="border-color: rgba(255,255,255,0.05) !important;">
                                    <div class="small text-muted">
                                        <div class="d-flex align-items-center mb-1">
                                            <i class="bi bi-geo-alt mr-2 text-primary"></i> <?php echo e($p->lokasi); ?>
                                    ...
                                    <a href="<?php echo e(route('pertandingan.show', $p->id)); ?>" class="btn btn-primary btn-sm rounded-pill px-3 shadow-sm">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <div class="bg-gradient rounded-circle p-2 d-flex align-items-center justify-content-center mr-3"
                                        ...
                                        <i class="bi <?php echo e($tournament->sport->icon ?? 'bi-trophy'); ?> text-white"></i>
                                    </div>
                                    <div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-4 text-center">
                                        <div class="text-warning font-weight-bold"><?php echo e($tournament->teams->count()); ?></div>
                                        <small class="text-muted" style="font-size: 0.7rem;">Tim</small>
                                    </div>
                                    <div class="col-4 text-center">
                                        <div class="text-success font-weight-bold"><?php echo e($tournament->pertandingans->where('status', 'finished')->count()); ?></div>
                                        <small class="text-muted" style="font-size: 0.7rem;">Selesai</small>
                                    </div>
                                    <div class="col-4 text-center">
                                        <div class="text-info font-weight-bold"><?php echo e($tournament->pertandingans->where('status', 'live')->count()); ?></div>
                                ...
                                ?>
                                <?php if($recentMatches->isNotEmpty()): ?>
                                    <div class="mb-3">
                                        ...
                                        <?php $__currentLoopData = $recentMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $match): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex justify-content-between align-items-center py-1 px-2 rounded mb-1" 
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <?php endif; ?>
                                                    <small class="text-white"><?php echo e($match->teamA?->name ?? 'TBD'); ?> vs <?php echo e($match->teamB?->name ?? 'TBD'); ?></small>
                                                </div>
                                                <?php if($match->status !== 'scheduled'): ?>
                                                    <small class="text-warning font-weight-bold"><?php echo e($match->score_a); ?> - <?php echo e($match->score_b); ?></small>
                                                <?php endif; ?>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                ...
                                <a href="<?php echo e(route('tournament.public.bracket', $tournament)); ?>" class="btn btn-outline-warning btn-sm w-100">
    ...
    <?php if($scheduledMatches->isNotEmpty()): ?>
        <div class="mb-4">
            <div class="d-flex align-items-center mb-4">
                <h4 class="text-white font-weight-bold mb-0 mr-3">
            ...
            <div class="row" id="scheduledMatchContainer">
                <?php $__currentLoopData = $scheduledMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6 col-xl-4 mb-4 match-card" data-id="<?php echo e($p->id); ?>">
    ...
    <?php if($liveMatches->isEmpty() && $scheduledMatches->isEmpty() && $tournaments->isEmpty()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\!UKDW\tugas-akhir\sistem-rectorcup\resources\views/dashboard.blade.php ENDPATH**/ ?>