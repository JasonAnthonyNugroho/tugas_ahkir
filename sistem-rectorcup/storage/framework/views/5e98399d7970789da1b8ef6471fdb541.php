...
<?php $__env->startSection('content'); ?>
    <div class="admin-header mb-5">
        ...
        <div class="admin-header-actions">
            ...
            <a href="<?php echo e(route('admin.tournament.bracket.builder')); ?>"
                ...
                <div class="col-lg-6 mb-4">
                    <div class="tournament-card">
                        ...
                        <div class="tournament-card-header">
                            <div class="d-flex align-items-center flex-grow-1 min-width-0">
                                <div class="tournament-sport-icon">
                                    <i class="bi <?php echo e($tournament->sport->icon ?? 'bi-diagram-3'); ?>"></i>
                                </div>
                                <div class="min-width-0 flex-grow-1">
                                    <h6 class="tournament-card-title"><?php echo e($tournament->name); ?></h6>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right tournament-dropdown">
                                    <a href="<?php echo e(route('admin.tournament.bracket.view', $tournament)); ?>" class="dropdown-item">
                                        <i class="bi bi-eye mr-2"></i> View Full Bracket
                                    </a>
                                    <button type="button" class="dropdown-item"
                                            data-toggle="modal" data-target="#editTournament<?php echo e($tournament->id); ?>">
                                        <i class="bi bi-pencil mr-2"></i> Edit Tournament
                                    </button>
                                    <div class="dropdown-divider"></div>
                                    <form action="<?php echo e(route('admin.bracket.reroll', $tournament->id)); ?>" method="POST" onsubmit="return confirm('Reroll akan mengacak ulang semua tim di bracket. Lanjutkan?')">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <form action="<?php echo e(route('admin.tournament.delete', $tournament)); ?>" method="POST" onsubmit="return confirm('Hapus tournament ini beserta semua pertandingannya?')">
                        ...
                        <div class="tournament-progress-section">
                            <div class="tournament-stats-row">
                                <div class="tournament-stat">
                                    <span class="tournament-stat-value"><?php echo e($totalMatches); ?></span>
                                ...
                                <div class="tournament-stat tournament-stat-live">
                                    <span class="tournament-stat-value">
                                        <span class="live-dot-mini"></span><?php echo e($liveMatches); ?>
                                ...
                                <div class="tournament-stat tournament-stat-done">
                                    <span class="tournament-stat-value"><?php echo e($finishedMatches); ?></span>
                                    <span class="tournament-stat-label">Selesai</span>
                                </div>
                                <div class="tournament-stat tournament-stat-sched">
                                    <span class="tournament-stat-value"><?php echo e($scheduledMatches); ?></span>
                                    <span class="tournament-stat-label">Terjadwal</span>
                                </div>
                                <div class="tournament-progress-pct"><?php echo e($progressPercent); ?>%</div>
                            </div>
                            <div class="tournament-progress-bar">
                                <div class="tournament-progress-fill" style="width: <?php echo e($progressPercent); ?>%"></div>
                                <?php if($liveMatches > 0 && $totalMatches > 0): ?>
                                    <div class="tournament-progress-live" style="left: <?php echo e($progressPercent); ?>%; width: <?php echo e(round(($liveMatches / $totalMatches) * 100)); ?>%"></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="tournament-matches-area">
                            <?php $__currentLoopData = $matchesByRound; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roundName => $roundMatches): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tournament-round-group">
                                    <div class="tournament-round-label">
                                        <i class="bi bi-layer-forward"></i>
                                        <span><?php echo e($roundName); ?></span>
                                        <span class="tournament-round-count"><?php echo e($roundMatches->count()); ?> match</span>
                                    </div>
                                    <div class="tournament-match-list">
                                        <?php $__currentLoopData = $roundMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="tmatch-card <?php echo e($p->status); ?>">
                                                <div class="tmatch-teams">
                                                    <div class="tmatch-team <?php echo e($p->winner_id && $p->winner_id == $p->team_a_id ? 'winner' : ''); ?> <?php echo e($p->winner_id && $p->winner_id != $p->team_a_id ? 'loser' : ''); ?>">
                                                        <span class="tmatch-team-name <?php echo e(!$p->team_a_id ? 'tbd' : ''); ?>">
                                                            <?php echo e($p->teamA?->name ?? 'TBD'); ?>

                                                        </span>
                                                        <?php if($p->status !== 'scheduled'): ?>
                                                            <span class="tmatch-score"><?php echo e($p->score_a ?? 0); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="tmatch-vs">
                                                    ...
                                                    <div class="tmatch-team <?php echo e($p->winner_id && $p->winner_id == $p->team_b_id ? 'winner' : ''); ?> <?php echo e($p->winner_id && $p->winner_id != $p->team_b_id ? 'loser' : ''); ?>">
                                                        <span class="tmatch-team-name <?php echo e(!$p->team_b_id ? 'tbd' : ''); ?>">
                                                            <?php echo e($p->teamB?->name ?? 'TBD'); ?>

                                                        </span>
                                                        <?php if($p->status !== 'scheduled'): ?>
                                                            <span class="tmatch-score"><?php echo e($p->score_b ?? 0); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="tmatch-action">
                                                    <?php if($p->status == 'live'): ?>
                                                        <a href="<?php echo e(route('admin.skor')); ?>#match-<?php echo e($p->id); ?>" class="tmatch-action-btn tmatch-action-live" title="Kelola Skor">
                                                            <i class="bi bi-sliders2"></i>
                                                        </a>
                                                    <?php elseif($p->status == 'finished'): ?>
                                                        <a href="<?php echo e(route('admin.skor')); ?>#match-<?php echo e($p->id); ?>" class="tmatch-action-btn tmatch-action-done" title="Lihat Detail">
                                                            <i class="bi bi-eye"></i>
                                                        </a>
                                                    <?php elseif($p->team_a_id && $p->team_b_id): ?>
                                                        <form action="<?php echo e(route('pertandingan.bulk-live')); ?>" method="POST" class="d-inline" onsubmit="return confirm('Mulai pertandingan <?php echo e($p->teamA?->name); ?> vs <?php echo e($p->teamB?->name); ?>?')">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="match_ids[]" value="<?php echo e($p->id); ?>">
                        ...
                        <div class="tournament-card-footer">
                            <a href="<?php echo e(route('admin.tournament.bracket.view', $tournament)); ?>" class="tournament-view-btn">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-12">
                    <div class="tournament-empty">
                        ...
                        <a href="<?php echo e(route('admin.tournament.bracket.builder')); ?>" class="btn btn-primary-action btn-sm mt-2">
    ...
    <?php $__currentLoopData = $tournaments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <div class="modal fade dash-modal" id="editTournament<?php echo e($tournament->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-content dash-modal-content">
                    <div class="dash-modal-header">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="dash-modal-subtitle"><?php echo e($tournament->name); ?></p>
                        </div>
                        <button type="button" class="dash-modal-close" data-dismiss="modal" aria-label="Close">
                            <i class="bi bi-x-lg"></i>
                        </button>
                    </div>
                    <form action="<?php echo e(route('admin.tournament.update', $tournament)); ?>" method="POST" class="mb-0">
                            ...
                            <div class="dash-form-section">
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" name="name" class="dash-input" value="<?php echo e($tournament->name); ?>" required>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label class="dash-label"><i class="bi bi-geo-alt mr-1"></i> Lokasi / GOR</label>
                                        <input type="text" name="lokasi" class="dash-input" value="<?php echo e($tLokasiEdit); ?>" placeholder="Contoh: GOR UKDW">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <?php $iMatches = $groupedMatches->get('independent', collect()); ?>
                            <?php $__empty_1 = true; $__currentLoopData = $iMatches->where('status', '!=', 'finished'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr data-match-id="<?php echo e($p->id); ?>">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="bg-primary rounded-circle p-2 d-flex align-items-center justify-content-center mr-3"
                                                ...
                                                <i class="bi <?php echo e($p->sport->icon ?? 'bi-trophy'); ?> text-primary small"></i>
                                            </div>
                                            <span class="font-weight-600"><?php echo e($p->sport->nama_sport ?? 'Tournament'); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-white small font-weight-bold"><?php echo e($p->waktu_tanding->format('d M, H:i')); ?></div>
                                    </td>
                                    <td>
                                        <div class="font-weight-600 text-uppercase small text-white">
                                            <?php echo e($p->teamA?->name ?? 'TBD'); ?> <span class="text-muted mx-2">VS</span> <?php echo e($p->teamB?->name ?? 'TBD'); ?>
                                    ...
                                    <td class="text-center">
                                        <?php if($p->status == 'scheduled'): ?>
                                            <button class="btn btn-sm btn-warning rounded-pill px-3 font-weight-bold" data-toggle="modal" data-target="#editMatch<?php echo e($p->id); ?>">
                                                Edit
                                            </button>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('admin.skor')); ?>?match=<?php echo e($p->id); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3 font-weight-bold">Update Skor</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="modal fade dash-modal" id="addMatchModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content dash-modal-content">
                ...
                <form id="formTambahJadwal" action="<?php echo e(route('pertandingan.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body dash-modal-body">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="sport_id" id="sportSelect" class="dash-input" required>
                                        ...
                                        <?php $__currentLoopData = $sports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sport->id); ?>" data-nama="<?php echo e(strtoupper($sport->nama_sport)); ?>">
                        ...
                        <div class="dash-form-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <input type="date" name="tanggal_match" id="tambah_tanggal" class="dash-input" required value="<?php echo e(date('Y-m-d')); ?>" onclick="this.showPicker ? this.showPicker() : null" style="min-height: 48px; font-size: 0.95rem; cursor: pointer;">
                                </div>
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 8px;">
                                        <div class="flex-grow-1">
                                            <select name="jam_match" id="tambah_jam" class="dash-input font-weight-bold" required style="min-height: 48px; font-size: 0.95rem;">
                                                <?php for($h = 0; $h < 24; $h++): ?>
                                                    <?php $hh = sprintf('%02d', $h); ?>
                                                    <option value="<?php echo e($hh); ?>" <?php echo e($hh == '09' ? 'selected' : ''); ?>>
                                                        Jam <?php echo e($hh); ?>
...
<?php $__currentLoopData = $pertandingans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($p->status == 'scheduled'): ?>
        <div class="modal fade" id="editMatch<?php echo e($p->id); ?>" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content"
                    ...
                    <form action="<?php echo e(route('pertandingan.update', $p->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <select name="sport_id" class="form-control" required>
                                        <?php $__currentLoopData = $sports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sport->id); ?>" <?php echo e($p->sport_id == $sport->id ? 'selected' : ''); ?>>
                                                <?php echo e($sport->nama_sport); ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="team_a_id" class="form-control">
                                        <option value="" <?php echo e(is_null($p->team_a_id) ? 'selected' : ''); ?> disabled>-- TBD (To Be Determined) --</option>
                                        <?php $__currentLoopData = $teams->where('prodi', '!=', 'TBD'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($team->id); ?>" <?php echo e($p->team_a_id == $team->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="team_b_id" class="form-control">
                                        <option value="" <?php echo e(is_null($p->team_b_id) ? 'selected' : ''); ?> disabled>-- TBD (To Be Determined) --</option>
                                        <?php $__currentLoopData = $teams->where('prodi', '!=', 'TBD'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($team->id); ?>" <?php echo e($p->team_b_id == $team->id ? 'selected' : ''); ?>>
                                                <?php echo e($team->name); ?>
                                ...
                                <div class="col-12 col-md-6 mb-4">
                                    ...
                                    <input type="date" name="tanggal_match" id="edit_tanggal_<?php echo e($p->id); ?>" class="form-control edit-tanggal-match" 
                                        value="<?php echo e($p->waktu_tanding ? \Carbon\Carbon::parse($p->waktu_tanding)->format('Y-m-d') : date('Y-m-d')); ?>" 
                                ...
                                <div class="col-12 col-md-6 mb-4">
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 8px;">
                                        <div class="flex-grow-1">
                                            <select name="jam_match" id="edit_jam_<?php echo e($p->id); ?>" class="form-control edit-jam-match font-weight-bold" required style="min-height: 48px; font-size: 0.92rem;">
                                                <?php for($h = 0; $h < 24; $h++): ?>
                                                    <?php $hh = sprintf('%02d', $h); ?>
                                                    <option value="<?php echo e($hh); ?>" <?php echo e($curH == $hh ? 'selected' : ''); ?>>
                                                        Jam <?php echo e($hh); ?>
                                        ...
                                        <span class="font-weight-bold text-muted px-1" style="font-size: 1.2rem;">:</span>
                                        <div style="width: 120px; flex-shrink: 0;">
                                            <input type="number" name="menit_match" id="edit_menit_<?php echo e($p->id); ?>" class="form-control edit-menit-match text-center font-weight-bold" min="0" max="59" step="1" placeholder="00" value="<?php echo e($curM); ?>" required style="min-height: 48px; font-size: 0.92rem;">
                                        </div>
                                        <span class="small font-weight-bold text-muted ml-1">WIB</span>
                                    </div>
                                    <small class="text-muted mt-1 d-block" style="font-size: 0.72rem;">
                                ...
                                <input type="hidden" name="waktu_tanding" id="edit_waktu_final_<?php echo e($p->id); ?>" value="<?php echo e($p->waktu_tanding ? \Carbon\Carbon::parse($p->waktu_tanding)->format('Y-m-d H:i:s') : ''); ?>">
                                <div class="col-md-6 mb-4">
                                    <label class="small font-weight-bold text-uppercase text-muted mb-2">Lokasi / GOR</label>
                                    <input type="text" name="lokasi" class="form-control" 
                                        value="<?php echo e($p->lokasi); ?>" placeholder="Contoh: GOR UKDW" required>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label class="small font-weight-bold text-uppercase text-muted mb-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\!UKDW\tugas-akhir\sistem-rectorcup\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>